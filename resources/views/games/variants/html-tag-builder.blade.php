...
<div x-data="gameLogic()" class="flex flex-col lg:flex-row h-screen lg:h-full w-full bg-[#f3f4f6] relative overflow-y-auto lg:overflow-hidden">
    ...
    <div class="w-full lg:w-[30%] lg:h-full p-4 sm:p-6 border-b-4 lg:border-b-0 lg:border-r-4 border-black flex flex-col bg-white lg:overflow-y-auto">
        ...
        <div class="mb-6">
            <div class="bg-[#1a1a1a] neo-border neo-shadow p-4 rounded-none relative">
                <div class="text-gray-400 font-mono text-sm mb-2">&lt;body&gt;</div>
                <textarea 
                    x-model="userCode" 
                    class="w-full bg-transparent text-[#00ff88] font-mono text-base resize-none outline-none focus:ring-0 border-none p-0 ml-4 min-h-[160px] lg:min-h-[120px]"
                    spellcheck="false"
                ></textarea>
                <div class="text-gray-400 font-mono text-sm mt-2">&lt;/body&gt;</div>
            </div>
        </div>
    ...
    <!-- CENTER PANEL (40%) -->
    <div class="w-full lg:w-[40%] lg:h-full p-4 sm:p-8 flex flex-col items-center justify-center bg-[#E34F26] border-b-4 lg:border-b-0 lg:border-r-4 border-black relative overflow-hidden min-h-[350px]">
        
        <!-- Live Browser Preview -->
        <div class="w-full h-full max-w-2xl bg-white neo-border neo-shadow flex flex-col" id="preview-container">
            <!-- Browser Chrome -->
            <div class="bg-gray-200 border-b-4 border-black p-3 flex gap-2 items-center">
                ...
                <div class="ml-4 bg-white px-4 py-1 neo-border text-sm font-bold flex-1 text-gray-500">
                    Browser Preview
                </div>
            </div>
            
            <!-- iframe container -->
            <div class="flex-grow p-0 relative bg-white">
                <iframe id="preview-frame" class="w-full h-full border-none" sandbox="allow-same-origin"></iframe>
            </div>
        </div>
