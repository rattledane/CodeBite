...
<div x-data="gameLogic()" class="flex flex-col lg:flex-row h-screen lg:h-full w-full bg-[#f3f4f6] relative overflow-y-auto lg:overflow-hidden">
    ...
    <div class="w-full lg:w-[30%] lg:h-full p-4 sm:p-6 border-b-4 lg:border-b-0 lg:border-r-4 border-black flex flex-col bg-white lg:overflow-y-auto">
        ...
        <div class="mb-6">
            <div class="bg-[#1a1a1a] neo-border neo-shadow p-4 rounded-none relative">
                <div class="text-gray-400 font-mono text-sm mb-2">#pond {</div>
                <textarea 
                    x-model="userCode" 
    ...
    <div class="w-full lg:w-[40%] lg:h-full p-4 sm:p-8 flex flex-col items-center justify-center bg-[#87CEEB] border-b-4 lg:border-b-0 lg:border-r-4 border-black relative overflow-hidden min-h-[300px]">
        ...
        <!-- Pond Visualization Area -->
        <div class="w-full aspect-square max-w-[500px] bg-[#1E90FF] neo-border neo-shadow relative p-4" id="pond-container">
            <!-- The user's CSS is injected here to affect the pond layout -->
            <div 
                class="w-full h-full flex" 
                :style="userCode"
            >
                <!-- Frogs -->
                <div class="w-16 h-16 bg-[#32CD32] neo-border flex items-center justify-center font-bold text-white text-3xl neo-shadow-sm rounded-full m-1">
                    🐸
                </div>
                <template x-if="currentLevel.order > 2">
                    <div class="w-16 h-16 bg-[#32CD32] neo-border flex items-center justify-center font-bold text-white text-3xl neo-shadow-sm rounded-full m-1">
                        🐸
                    </div>
                </template>
                <template x-if="currentLevel.order > 3">
                    <div class="w-16 h-16 bg-[#32CD32] neo-border flex items-center justify-center font-bold text-white text-3xl neo-shadow-sm rounded-full m-1">
                        🐸
                    </div>
                </template>
